...
CONFIG = {
    ...
    # "Today" at scoring time so staleness signals (stuck status, stalled
    # payments) stay accurate as the portfolio ages. Tests can pin a fixed
    # date by overwriting CONFIG['reference_date'] before scoring.
